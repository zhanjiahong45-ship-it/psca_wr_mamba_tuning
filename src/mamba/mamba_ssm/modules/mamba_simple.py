...
class Mamba(nn.Module):
    def __init__(
        ...
        conv_bias=True,
        bias=False,
        use_fast_path=None,  # Fused kernel options
        layer_idx=None,
        device=None,
        dtype=None,
        backend="cuda",
        ...
        self.selective_scan_fn = {
            "cuda": selective_scan_fn, "ref": selective_scan_ref, "naiv": selective_scan_naiv
        }[backend]

        self.use_fast_path = use_fast_path if use_fast_path is not None else backend == "cuda"
