...
def create_block(
    ...
    **kwargs
    ...
    mixer_cls = partial(mamba_cls, layer_idx=layer_idx, **ssm_cfg, **factory_kwargs)
    norm_cls = partial(
...
class MambaLMHeadModel(nn.Module, GenerationMixin):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # self.lm_head = lambda x: self.backbone.embedding(x)
    ...
    def from_pretrained(cls, pretrained_model_name, device=None, dtype=None, config_name=None, **kwargs):
        config_data = load_config_hf(pretrained_model_name if config_name is None else config_name)
